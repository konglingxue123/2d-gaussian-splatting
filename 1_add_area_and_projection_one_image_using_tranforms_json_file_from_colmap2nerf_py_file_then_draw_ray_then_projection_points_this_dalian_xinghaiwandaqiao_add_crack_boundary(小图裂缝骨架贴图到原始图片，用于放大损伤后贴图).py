...
crack_mask_magma_dir = '/home/ubunto/Project/konglx/pcd/2dgs/2d-gaussian-splatting-main/tools/red_contour.png'
...
# mesh + points + 相机中心点
    ...
    # 保存可视化结果
    o3d.io.write_point_cloud(os.path.join(f'{save_output_mesh_ray_dir}', 'scene_added_area_boundary.ply'), pcd)
    print(f'已保存可视化结果: {save_output_mesh_ray_dir}/scene_added_area_boundary.ply')
    ...
    o3d.io.write_triangle_mesh(os.path.join(f'{save_output_mesh_ray_dir}', 'ray_hit_mesh_boundary.ply'), mesh)
    print(f'已保存可视化结果: {save_output_mesh_ray_dir}/ray_hit_mesh_boundary.ply')
