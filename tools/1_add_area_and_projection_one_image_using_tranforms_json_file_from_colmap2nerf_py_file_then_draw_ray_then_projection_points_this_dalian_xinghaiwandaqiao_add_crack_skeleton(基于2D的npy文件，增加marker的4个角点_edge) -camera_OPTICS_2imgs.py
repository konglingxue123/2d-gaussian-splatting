...
# 5.1 转换为 TensorMesh 并添加到 RaycastingScene
    ...
    for i in range(len(direction_each_img)):
        if np.isfinite(t_hits[i]):
            # print('chosen_camera_center_coords_list_all:', chosen_camera_center_coords_list_all)
            
            hit_point = chosen_camera_center_coords_list_all[id_num][0] + direction_each_img[i] * t_hits[i]
            ...
            hit_points_colors_each_img.append(crack_mask_magma_np_color_not_zero_list[i])
